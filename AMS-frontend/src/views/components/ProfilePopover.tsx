...
const ProfilePopover = () => {
  ...
  const updatePassword = async () => {
    ...
    try {
      const res = await axiosInstance.post("/user/update-password", params);
  ...
  return (
    <div className="flex items-center gap-6">
      ...
      {/* //Update Password  */}
      <Dialog open={updatePasswordModal} onOpenChange={handlePasswordDialog}>
        <DialogContent className="bg-white">
          <DialogHeader>
              ...
              <div>
                <div className="flex flex-col space-y-1 mt-4">
                  ...
                  <input
                    ...
                    className={cn(
                      "inputClass",
                      error && currentPassword === "" && "inputErrorClass",
                    )}
                  />
