      ...
      <div className="flex flex-col space-y-3">
        <div className="flex gap-4 max-sm:flex-col">
          <div className="flex flex-col space-y-1 w-full text-start">
            ...
            <input
              ...
              autoFocus
            />
            <span className="text-red-500 text-[10px]">{errorObj?.title}</span>
          </div>
        </div>
        <div className="flex gap-4 max-sm:flex-col">
          <div className="flex flex-col space-y-1 w-full text-start">
        ...
        <div className="flex gap-4 max-sm:flex-col">
          <div className="flex flex-col space-y-1 w-full text-start">
            ...
            <span className="text-red-500 text-[10px]">{errorObj?.genre}</span>
          </div>
        </div>
        ...
        <div className="text-end">
          <Button
            ...
            onClick={updateAction ? handleUpdateMusic : handleAddSong}
          >
